...
//ya
        ...
        <tr>
            ...
            <td>
            <?php 
                if ($row ['bagian_terkini'] == ""){
            ?>       
                <a href="?page=karyawanbagian&id=<?php echo $row['id']?>"class="btn bg-danger btn-sm mr-1">
                    <i class="fa da building"></i>Belum Ada
                </a>
            <?php
            } else {
            ?>
                <a href="?page=karyawanbagian&id=<?php echo $row['id'] ?>" class="btn bg-fuchsia btn-sm mr-1">
                    <i class="fa da building"></i> <?php echo $row['bagian_terkini'] ?>
                </a>
            <?php
            }
            ?>
